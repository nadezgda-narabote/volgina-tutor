...
const quizData=[
  {
    ...
    correct:'В',
    feedback:{
      'А':'<strong>В этом варианте ошибки нет.</strong><p><b>Дождь начался</b> и <b>мы вернулись</b> — две грамматические основы. Придаточная часть с союзным словом <b>когда</b> стоит перед главной и отделена от неё запятой правильно.</p>',
