...
const quizData=[
  {
    ...
    feedback:{
      ...
      'В':'<strong>Верно.</strong><p>В предложении две грамматические основы: <b>солнце скрылось</b> и <b>стало прохладно</b>. Это сложносочинённое предложение. Его части соединены союзом <b>и</b>, поэтому перед ним нужна запятая.</p><p>Правильно:</p><p class="corrected-sentence">Солнце скрылось за лесом, и стало прохладно.</p><p class="formula">ДВЕ ГРАММАТИЧЕСКИЕ ОСНОВЫ → ГРАНИЦА ЧАСТЕЙ → ЗАПЯТАЯ ПЕРЕД СОЮЗОМ И</p>',
...
const reviewData=[
  ...
  },
  {
    ...
    text:[
      'Очень компетентный преподаватель! Помимо хорошей подачи материала, на уроках приятная атмосфера. Надежда Александровна может подготовить к экзаменам и в сжатые сроки, и в спокойном темпе.',
      'Сама занимаюсь с 8-го класса. Сначала просто разбирали проблемные темы, затем в 9-м классе готовилась к ОГЭ (получила желаемый результат), а сейчас готовлюсь к ЕГЭ 💞'
    ]
  },
  {
    ...
    text:[
      ...
      'У меня был средний уровень знаний, и поначалу казалось, что до высоких баллов очень далеко. Но Надежда Александровна сумела выстроить подготовку так, что шаг за шагом пробелы закрывались, а уверенность росла. Отдельно хочу отметить работу над тестовой частью: разбирали не только правильные ответы, но и типичные ловушки и логику заданий, поэтому решать их становилось намного проще.',
      'Отдельно хочу поблагодарить Надежду Александровну за подготовку к сочинению и изложению. Мы прорабатывали самые разные темы, учились выстраивать аргументацию и не терять главную мысль. Благодаря этим занятиям я перестала бояться творческих заданий: теперь вижу структуру и понимаю, как грамотно раскрыть тему.',
      ...
      'Год подготовки к ЕГЭ прошёл незаметно: мы не просто «проходили материал», а действительно разбирали всё до мелочей, возвращались к тому, что вызывало трудности, и закрепляли на практике. В начале пути на пробниках я набирала меньше 60 баллов, а итоговый результат — 83 балла. Для меня это настоящий прорыв, и я точно знаю, что это заслуга моего преподавателя.',
      'И вот что особенно трогает: Надежда Александровна не исчезла из моей жизни после экзаменов. Она по-прежнему интересуется, как у меня дела, и это очень много значит.',
  ...
  {
    id:'sasha',name:'Саша',role:'выпускница',context:'ОГЭ по русскому языку',sourceType:'real-message',ownerDecision:'publish',
    text:['Суперпедагог! Очень внимательно относится к подбору материалов, постоянно интересуется, всё ли понятно. Если нет, материал повторяется! Материал преподносится очень легко и интересно: не успеваешь заметить, как занятие подходит к концу. Видно, что преподавателю важно, чтобы всё было отработано и понятно ученику!','Огромная благодарность! Всем советую этого специалиста 💕💕💕']
  },
  {
    id:'maria',name:'Мария',role:'выпускница',context:'ОГЭ по литературе',sourceType:'real-message',ownerDecision:'publish',
    text:[
      'Я занималась с Надеждой Александровной в 9-м классе: мы готовились к ОГЭ по литературе! Я всегда считала, что нереально подготовиться к такому серьёзному и непростому экзамену менее чем за год, но Надежда Александровна доказала обратное 😁',
      'Мне повезло: Надежда Александровна преподавала русский язык и литературу в моей школе. Я знала, как она умеет увлечь и заинтересовать своими предметами, поэтому выбрала её в качестве репетитора по литературе!',
    ...
    preview:['Я занималась с Надеждой Александровной в 9-м классе: мы готовились к ОГЭ по литературе! Я всегда считала, что нереально подготовиться к такому серьёзному и непростому экзамену менее чем за год, но Надежда Александровна доказала обратное 😁']
  },
  {
