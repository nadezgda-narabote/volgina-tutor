...
const reviewData=[
  ...
  {
    id:'sasha',name:'Саша',role:'отзыв об индивидуальных занятиях',sourceType:'real-message',ownerDecision:'publish',
  ...
  {
    id:'maria',name:'Мария',role:'ученица, ОГЭ по литературе',class:'9 класс',sourceType:'real-message',ownerDecision:'publish',
    text:[
  ...
  {
    id:'mama-dani',name:'Мама Дани',role:'русский язык и литература',sourceType:'real-message',ownerDecision:'publish',
  ...
  {
    id:'igor',name:'Игорь',role:'авторский пример, папа ученика',class:'9 класс',sourceType:'author-draft',ownerDecision:'publish-as-labeled-example',
