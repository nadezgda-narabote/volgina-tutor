...
const reviewData=[
  ...
  {
    id:'alyona',name:'Алёна',role:'ученица, занимается с 8 класса',sourceType:'real-message',ownerDecision:'publish',
    text:[
  ...
  {
    id:'dasha',name:'Даша',role:'выпускница, подготовка к ОГЭ и ЕГЭ',sourceType:'real-message',ownerDecision:'publish',
    text:[
  ...
  {
    id:'sasha',name:'Саша',role:'отзыв об индивидуальных занятиях',sourceType:'real-message',ownerDecision:'awaiting-owner-confirmation',
  ...
  {
    id:'maria',name:'Мария',role:'ученица, ОГЭ по литературе',class:'9 класс',sourceType:'real-message',ownerDecision:'awaiting-owner-confirmation',
    text:[
  ...
  {
    id:'mama-dani',name:'Мама Дани',role:'русский язык и литература',sourceType:'real-message',ownerDecision:'awaiting-owner-confirmation',
  ...
  {
    id:'ekaterina',name:'Екатерина',role:'мама Юли',sourceType:'real-message',ownerDecision:'awaiting-owner-confirmation',
  ...
  {
    id:'anastasia',name:'Анастасия',role:'мама ученика',class:'9 класс',sourceType:'real-message',ownerDecision:'awaiting-owner-confirmation',
    text:['29 баллов','Позанимались то всего ничего - а результат очевиден','Это ваша заслуга 🌹']
  },
  {
    id:'igor',name:'Игорь',role:'папа ученика',class:'9 класс',sourceType:'author-draft',ownerDecision:'internal-only',
...
document.querySelectorAll('[data-stories]').forEach(stories=>{
  ...
  const publicReviewIds=new Set(['natalya-alekseevna','alyona','dasha']);
